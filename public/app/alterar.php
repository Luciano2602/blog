...
<?php
    ...
    if(isset($_POST['titulo'])){
        ...
        $fraseAutor   = utf8_decode($_POST["fraseAutor"]);
        $textoCurto   = utf8_decode($_POST["textoCurto"]);
        $id_post      = $_POST["id_post"];
        
        
        $alterando = "update post set ";
        $alterando .= "titulo ='{$titulo}', ";
        $alterando .= "sub_titulo ='{$sub_titulo}', ";
        $alterando .= "noticia ='{$noticia}', ";
        $alterando .= "fraseAutor ='{$fraseAutor}', ";
        $alterando .= "textoCurto ='{$textoCurto}' ";
        $alterando .= "Where id_post = {$id_post} ";
        
        $alterarPost = mysqli_query($conexao, $alterando);
